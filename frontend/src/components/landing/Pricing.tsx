      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 max-w-xl mx-auto mb-10">
            ...
            <br/><span className="text-sm text-indigo-400 mt-2 block">(GPT-4o-mini: 1 Kredi, Claude-3.5: 3 Kredi, GPT-4o: 4 Kredi)</span>
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          >
            ...
            <ul className="space-y-4 text-sm text-gray-300">
              ...
              <li className="flex gap-3"><Check className="w-5 h-5 text-indigo-400 shrink-0" />Aylık 20.000 Kredi</li>
          ...
          >
            ...
            <ul className="space-y-4 text-sm text-gray-400">
              ...
              <li className="flex gap-3"><Check className="w-5 h-5 text-indigo-500 shrink-0" />Sınırsız veya Özel Kredi Paketi</li>
