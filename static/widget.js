...
(function () {
  ...
  async function sendMessage() {
    ...
    try {
      ...
      if (rawText.replace(/\s+/g,'').includes("[TICKET_FORM_RENDER]")) {
        botBubble.innerHTML = 
          ...
          if (btn) {
            btn.addEventListener("click", async () => {
              ...
              try {
                ...
                botBubble.innerHTML = <div style="padding: 12px; background: rgba(16, 185, 129, 0.1); border: 1px solid rgba(16, 185, 129, 0.2); border-radius: 12px; color: #34d399; text-align: center; font-size: 13px;">✅ Talebiniz destek ekibimize başarıyla iletildi! Numaranızı ve sorununuzu aldık.</div>;
              } catch(e) {
